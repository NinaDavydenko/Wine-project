    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetTwoFactorSuccess ? "Налаштований постачальник двофакторної аутентифікації."
                : message == ManageMessageId.Error ? "Відбулась помилка."
                : message == ManageMessageId.AddPhoneSuccess ? "Ваш номер телефону додано."
                : message == ManageMessageId.RemovePhoneSuccess ? "Ваш номер телефону видалено."
                : "";
